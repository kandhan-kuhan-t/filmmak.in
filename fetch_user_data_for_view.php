...
$query = "select users_profile.*,contact_number,email_id from users_profile join contact on contact.username = users_profile.username having username = '$username'";
...
$response['birth_year'] = $result['birth_year'];
$response['birth_date'] = $result['birth_date'];
